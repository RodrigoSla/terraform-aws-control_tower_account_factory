...
| <a name="terraform_workspace_prefix"></a> [terraform\_workspace\_prefix](#input\_terraform\_workspace\_prefix) | Prefix for the Terraform workspace name. | `string` | `"aws"` | no |
| <a name="terraform_core_project_name"></a> [terraform\_core_project\_name](#input\_terraform\_core\_project\_name) | Name of the core project for AFT for use in TFE / TFC. | `string` | `"aft-core"` | no |
| <a name="terraform_customization_project_prefix"></a> [terraform\_customization\_project\_prefix](#input\_terraform\_customization\_project\_prefix) | Prefix for the projects for accounts for use in TFE / TFC. | `string` | `"account"` | no |
